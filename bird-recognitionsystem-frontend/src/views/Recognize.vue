  ...
  <Layout>
    <div class="recognize">
      <el-card class="upload-card">
        <h2>鸟区域检测</h2>
        <p class="tip">上传图片后，系统会检测图像中的鸟，并返回每个鸟区域的位置与置信度。</p>
        ...
        <div class="action-bar">
          ...
          <el-button type="primary" size="large" :loading="loading" :disabled="!selectedFile" @click="handleRecognize">
...
const handleRecognize = async () => {
  ...
  try {
    ...
    sessionStorage.setItem('latestRecognizeResult', JSON.stringify(result))
    router.push({
      path: '/result',
